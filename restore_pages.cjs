        ...
        <div className="max-w-[1000px] mx-auto px-6 text-center">
           <div className="bg-white/80 backdrop-blur-xl p-10 md:p-20 rounded-[48px] shadow-[0_30px_80px_-20px_rgba(0,0,0,0.08)] border border-white">
             ...
             <div className="flex flex-col md:flex-row items-center justify-center gap-8 w-full">
               <ImageWithFallback src={partnersBottomImg} alt="Our Success Partners 1" className="w-full h-auto max-w-[400px] object-contain rounded-2xl drop-shadow-md" />
             </div>
           </div>
        </div>
...
let newContent = content.replace(/function ContactPage\(\) \{/, storiesPage + "\n\n" + aboutPage + "\n\n" + missionPage + "\n\nfunction ContactPage() {");
fs.writeFileSync('src/app/App.tsx', newContent);
