      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="p-9 md:p-14 lg:p-20 flex flex-col justify-center">
          <span
            ...
            style={{ color: C_BLUE }}
          >
            {t("marketing_story_label", "How we think about it")}
          </span>

          <p className="text-5xl md:text-6xl font-extrabold leading-[1.1] tracking-tight text-[#1a1a1a] mb-7">
            {t("marketing_story_title", "You order an ice cream. It arrives with a spoon made of chocolate.")}
          </p>

          <div className="flex flex-col gap-8 text-xl md:text-2xl leading-[1.8] text-[#1a1a1a]/70 font-medium">
            <p>
              {t("marketing_story_p1", "Nobody asked for that. It costs almost nothing. But now the dessert is a small event - the guest photographs it before they eat it, and they tell someone about it later.")}
            </p>
            <p>
              {t("marketing_story_p2", "That's the part of marketing we care about most: the thing the guest is actually holding. Get that right and the content makes itself.")}
            </p>
          </div>

          <div className="mt-9 pt-8 border-t border-black/[0.07] grid grid-cols-3 gap-8">
            {[
              { n: "01", t: t("marketing_story_step_1", "Design the moment"), c: C_ORANGE },
              { n: "02", t: t("marketing_story_step_2", "Capture it properly"), c: C_PINK },
              { n: "03", t: t("marketing_story_step_3", "Put it where people are"), c: C_BLUE },
            ].map((s) => (
              <div key={s.n}>
                <div
