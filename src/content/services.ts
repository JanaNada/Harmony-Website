    ...
    groups: [
      ...
      },
      {
        ...
        modules: [
          ...
          { id: "biz-mystery-shopper", label: "Mystery Shopper", desc: "Anonymous guest checks that reveal the real customer experience.", long: "The Mystery Shopper program evaluates service quality through unannounced visits, providing valuable insights into guest experiences and areas for improvement.", image: IMG.boardroom, icon: Search },
        ],
      },
    ],
    questions: [
